function Validation(values) {
    ...
    if (!values.confirm) {
         errors.confirmError = "Please confirm your password!*"
    } else if (values.password !== values.confirm) {
        errors.confirmError = "Password does not match!*"
    };
        
    // Validate check boxes 
    if (!values.checkBox1) {
        errors.checkBox1Error = "Please make sure you tick the box!*";}
    
    if (!values.checkBox2) {
        errors.checkBox2Error = "Please make sure you tick the box!*";}
